    ...
    <div class="row">
      <div class="col-12">
        ...
        <nav class="navbar navbar-expand-lg navbar-light p-0">
          ...
          <!-- navbar -->
          <?php if( "http://" . $_SERVER['SERVER_NAME']. $_SERVER['REQUEST_URI'] == "http://localhost/texcutive1/pexdex" ) { ?>
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
              <li class="nav-item active">
                <a class="nav-link" href="<?php echo base_url("pexdex"); ?>">HOME</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url("pexdex/about"); ?>"> ABOUT</a>
              </li>
			        <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url("pexdex/support"); ?>"> SUPPORT</a>
              </li>
			        <li class="nav-item">
                <a class="nav-link" href="#downscroll-page"> GET AN ESTIMATE</a>
              </li>
			  <!--<li class="nav-item">
                <a class="nav-link" href="<?php echo base_url("pexdex/getEstimate"); ?>"> GET AN ESTIMATE</a>
              </li>-->
...
<?php $this->load->view('pexdex/'.$content);?>
...
$('#mobileform').on('submit', function(event){
 ...
 $.ajax({
  url:"<?php echo base_url(); ?>pexdex/ordertrack",
  method:"POST",
  data:$(this).serialize(),
  dataType:"json",
  // beforeSend:function(){
...
$('#otpform').on('submit', function(event){
 event.preventDefault();
 $.ajax({
  url:"<?php echo base_url(); ?>pexdex/orderotp",
  method:"POST",
  data:$(this).serialize(),
  dataType:"json",
  // beforeSend:function(){
  ...
  success:function(data)
  {
   ...
   if(data.success)
   {
    ...
    window.location = '<?php echo base_url(); ?>pexdex/orderHistory';
   }
