    ...
    <div class="container">
		...
		<div class="row">
          <div class="col-md-7">
            ...
            <input type="text" name="mobile" class="form-control" value="<?php echo set_value('mobile', $service->mobile) ?>" placeholder="Enter here"  tabIndex="2" >
			   ...
			   <div class="clearfix"></div>
				...
				<div class="col-sm-12">
                    ...
                    <div class="qtybox">				   
					   ...
					   <!-- <form action="<?php // echo base_url('pexdex/qytcalculation')?>" method="post" id="qytId"> -->
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body p-5">
           ...
           <form class="form-row mt-4 align-items-center"  action="<?php echo base_url('pexdex/resendMobile'); ?>" id="mobileform"  method="post" >
...
if (gift_check.checked == true){
  gift=1;
    ...
    $.ajax({
        type: "POST",
       // dataType:'json',
        url: '<?php echo base_url('pexdex/giftcalculation');?>',
        data: {
            'gift' : gift,
...
if (delicate_check.checked == true){
  delicate=1;
    ...
    $.ajax({
        type: "POST",
       // dataType:'json',
        url: '<?php echo base_url('pexdex/delicatecalculation');?>',
        data: {
            'delicate' : delicate,
             'id' : <?php  echo $service->id; ?>,
        },
...
if (urgent_check.checked == true){
  urgent=1;
    ...
    $.ajax({
        type: "POST",
       // dataType:'json',
        url: '<?php echo base_url('pexdex/urgentcalculation');?>',
        data: {
            'urgent' : urgent,
             'id' : <?php  echo $service->id; ?>,
        },
  ...
  var id = <?php  echo $service->order_id; ?>
...
$('#myFormID').on('submit', function(event){
 ...
 $.ajax({
  url:"<?php echo base_url(); ?>pexdex/optGenrate",
  method:"POST",
  data:$(this).serialize(),
  dataType:"json",
  // beforeSend:function(){
  ...
  window.location = '<?php echo base_url(); ?>pexdex/payment/' + id ;
   }
...
$('#contact_form').on('submit', function(event){
 event.preventDefault();
 $.ajax({
  url:"<?php echo base_url(); ?>pexdex/userData",
  method:"POST",
  data:$(this).serialize(),
  dataType:"json",
  // beforeSend:function(){
...
function increaseValue() {
 ...
 // document.getElementById("qytId").submit();
  ...
  $.ajax({
        type: "POST",
       // dataType:'json',
        url: "<?php echo base_url();?>pexdex/qytcalculation",
        data: {
            'qyt' : qyt,
            'id' : <?php  echo $service->id; ?>,
        },
...
$('#mobileform').on('submit', function(event){
 event.preventDefault();
 $.ajax({
  url:"<?php echo base_url(); ?>pexdex/resendMobile",
  method:"POST",
  data:$(this).serialize(),
  dataType:"json",
  // beforeSend:function(){
