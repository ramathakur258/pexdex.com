		...
		<div class="row">
          <div class="col-md-7">
			...
			<!-- </form> -->
			 ...
			 <!-- <form action="<?php // site_url('pexdex/service');?>" method="post"   >  -->
    ...
    <div class="modal-content">
      ...
      <div class="modal-body p-5">
           <h5>Add Your Extra Large Parcel 25KG. Or Above Weight</h5> 
			...
			<form class="form-row mt-4 align-items-center"  action="<?php echo base_url('pexdex/weightCal'); ?>" id="FormID"  method="post" >
...
$('#FormID').on('submit', function(event){
 ...
 $.ajax({
  url:"<?php echo base_url(); ?>pexdex/weightCal",
  method:"POST",
  data:$(this).serialize(),
  dataType:"json",
  // beforeSend:function(){
