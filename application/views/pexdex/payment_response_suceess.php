                  ...
                  <div class="col-md-8">
                        ...
                        <div class="c-boxlist">
                           <div class="row">
                              ...
                              <div class="col-5 col-sm-4 col-lg-4">
                                 <h6><?php echo date("d-M-Y",strtotime($orderDetail->update_time)); ?></h6>
                              </div>
                           </div>
                        </div>
                        <hr>
					...
					<div class="col-sm-6 col-md-6 col-lg-6">
                      ...
                      <!-- <a href="window.print()"  > Print Order</a> -->
							<a href="<?php echo base_url("pexdex");?>" class="waves-effect waves-light purchase-btn-thanksyou">New Order</a>
					      </div>
					  </div>
